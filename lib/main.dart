    ...
    return Center(
      child: SizedBox(
        ...
        child: Column(
          ...
          children: <Widget>[
          const Text ('Click the button to find out the price BTC/USDT', textAlign: TextAlign.center),
          ElevatedButton(
            onPressed: pressButton,
            child: Text ('Price BTC/USDT $priceToken', textAlign: TextAlign.center,)
            ),
          ],
        ),
      ),
